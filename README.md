...
文章生成は `src/llmClient.js` に集約しています。

現在はローカルのOllama内部APIを利用します。

- Endpoint: `http://127.0.0.1:11434`
- Model: `gemma4:e4b`

Ollamaが起動していない場合や生成に失敗した場合は、既存のテンプレート提案を表示します。

将来OpenAIなどの外部APIへ切り替える場合は、`TextGenerationGateway` のProviderを追加・差し替えます。
